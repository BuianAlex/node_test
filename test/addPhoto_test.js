      ...
      it('add photo with minimum required parameters (fileName) -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.have.property('fileName').and.to.be.equal('unnamed.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('50011')
      ...
      it('add photo change the name to "newName" -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.be.a('object')
            res.should.have.status(200)
            res.body.should.have.property('fileName').and.to.be.equal('newName.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('50011')
            done()
          })
      ...
      it('add photo change width and heigh  -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.be.a('object')
            res.should.have.status(200)
            res.body.should.have.property('fileName').and.to.be.equal('small.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('4066')
            done()
          })
      })
      ...
      it('add photo and change width to 0px  -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.be.a('object')
            res.should.have.status(200)
            res.body.should.have.property('fileName').and.to.be.equal('nullWidth.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('4066')
            done()
          })
      ...
      it('add photo change only width  -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.be.a('object')
            res.should.have.status(200)
            res.body.should.have.property('fileName').and.to.be.equal('onlyWidth.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('21420')
            done()
          })
      })
      it('add photo change only heigh  -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.be.a('object')
            res.should.have.status(200)
            res.body.should.have.property('fileName').and.to.be.equal('onlyHeigh.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('21420')
            done()
          })
      ...
      it('add photo change alt text  -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.be.a('object')
            res.should.have.status(200)
            res.body.should.have.property('fileName').and.to.be.equal('smile.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('50011')
            res.body.should.have.property('altText').and.to.be.equal('smile')
            done()
          })
      })
      it('add photo in grey scale  -> 200', (done) => {
        authenticatedUser
          ...
          .end((err, res) => {
            ...
            res.body.should.be.a('object')
            res.should.have.status(200)
            res.body.should.have.property('fileName').and.to.be.equal('smileGrey.jpg')
            res.body.should.have.property('path').and.to.be.equal('img/users/1')
            res.body.should.have.property('size').and.to.be.equal('25580')
            done()
          })
      })
    })
